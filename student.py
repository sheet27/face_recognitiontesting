...
class Student:
    def __init__(self,root):
        ...
        # first image
        img=Image.open(r"C:\Users\HP\Pictures\college_photos\face.png")
        ...
        # third image
        img2=Image.open(r"C:\Users\HP\Pictures\college_photos\student_class.jpg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("time new roman",35,"bold"),bg="white",fg="dark green")
        ...
        img_left=Image.open(r"C:\Users\HP\Pictures\college_photos\stud.jpg")
        ...
        radiobtn2=ttk.Radiobutton(class_student_frame,variable=self.var_radio1,text="Take No Photo Sample",value="No")
        ...
        img_right=Image.open(r"C:\Users\HP\Pictures\college_photos\high_school.jpg")
        ...
        search_btn=Button(search_frame,text="Update",width=12,font=("times new roman",12,"bold"),bg="blue",fg="white")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',user='root',password='',database='file')
                my_cursor=conn.cursor()
                my_cursor.execute('insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)',(
    #myconn = mysql.connector.connect(host="localhost",user="root",password="",database="from_alpine")
                                                                                        self.var_dep.get(),
                                                                                        self.var_course.get(),
                                                                                        self.var_year.get(),
