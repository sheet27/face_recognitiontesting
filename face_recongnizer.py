...
class FaceRecognition:
    def __init__(self, root):
        ...
        # 1st image
        img_top = Image.open(r"C:\Users\HP\Pictures\college_photos\face3.jpg")
        ...
        # 2st image
        img_button = Image.open(r"C:\Users\HP\Pictures\college_photos\scan.webp")
        img_button = img_button.resize((950, 700), Image.ANTIALIAS)
        self.photoimg_button = ImageTk.PhotoImage(img_button)
    ...
    def face_recog(self):
        ...
        while True:
            ...
            cv2.imshow("Welcomr to Face Recognition",img)
